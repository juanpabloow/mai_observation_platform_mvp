...
const navStub = resolve("tools/.next-nav-rep-stub.jsx");
writeFileSync(
  navStub,
...
await build({
  entryPoints: ["tools/reportsHarness.tsx"],
  bundle: true,
  format: "iife",
  target: "es2020",
  jsx: "automatic",
  ...
  outfile: join(out, "reports-harness.js"),
  logLevel: "warning",
});

writeFileSync(
  join(out, "reports-harness.html"),
  `<!doctype html><html lang="es"><head><meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Pestaña Reportes · arnés</title><link rel="stylesheet" href="${css}">
</head><body class="bg-background"><div id="root"></div>
<script src="reports-harness.js"></script></body></html>`,
);
console.log(`  ✓ ${join(out, "reports-harness.html")}`);
